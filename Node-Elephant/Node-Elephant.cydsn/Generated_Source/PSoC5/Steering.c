...
*
* \funcusage
*  \snippet Steering_SUT.c usage_Steering_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Steering_SUT.c usage_Steering_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Steering_SUT.c usage_Steering_Read  
*******************************************************************************/
...
* preferred Steering_Read() API because the 
* Steering_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Steering_SUT.c usage_Steering_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Steering_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Steering_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Steering_0_INTR       (First pin in the list)
    *  - Steering_1_INTR       (Second pin in the list)
    *  - ...
    *  - Steering_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Steering_SUT.c usage_Steering_SetInterruptMode
    *******************************************************************************/
    void Steering_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Steering_0_INTR) != 0u) 
		{ 
			 Steering_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Steering_SUT.c usage_Steering_ClearInterrupt
    *******************************************************************************/
