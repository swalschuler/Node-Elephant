...
*
* \funcusage
*  \snippet Throttle_1_SUT.c usage_Throttle_1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Throttle_1_SUT.c usage_Throttle_1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Throttle_1_SUT.c usage_Throttle_1_Read  
*******************************************************************************/
...
* preferred Throttle_1_Read() API because the 
* Throttle_1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Throttle_1_SUT.c usage_Throttle_1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Throttle_1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Throttle_1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Throttle_1_0_INTR       (First pin in the list)
    *  - Throttle_1_1_INTR       (Second pin in the list)
    *  - ...
    *  - Throttle_1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Throttle_1_SUT.c usage_Throttle_1_SetInterruptMode
    *******************************************************************************/
    void Throttle_1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Throttle_1_0_INTR) != 0u) 
		{ 
			 Throttle_1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Throttle_1_SUT.c usage_Throttle_1_ClearInterrupt
    *******************************************************************************/
