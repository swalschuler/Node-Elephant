...
*
* \funcusage
*  \snippet Brake_1_SUT.c usage_Brake_1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Brake_1_SUT.c usage_Brake_1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Brake_1_SUT.c usage_Brake_1_Read  
*******************************************************************************/
...
* preferred Brake_1_Read() API because the 
* Brake_1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Brake_1_SUT.c usage_Brake_1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Brake_1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Brake_1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Brake_1_0_INTR       (First pin in the list)
    *  - Brake_1_1_INTR       (Second pin in the list)
    *  - ...
    *  - Brake_1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Brake_1_SUT.c usage_Brake_1_SetInterruptMode
    *******************************************************************************/
    void Brake_1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Brake_1_0_INTR) != 0u) 
		{ 
			 Brake_1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Brake_1_SUT.c usage_Brake_1_ClearInterrupt
    *******************************************************************************/
