...
*
* \funcusage
*  \snippet Brake_2_SUT.c usage_Brake_2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Brake_2_SUT.c usage_Brake_2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Brake_2_SUT.c usage_Brake_2_Read  
*******************************************************************************/
...
* preferred Brake_2_Read() API because the 
* Brake_2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Brake_2_SUT.c usage_Brake_2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Brake_2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Brake_2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Brake_2_0_INTR       (First pin in the list)
    *  - Brake_2_1_INTR       (Second pin in the list)
    *  - ...
    *  - Brake_2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Brake_2_SUT.c usage_Brake_2_SetInterruptMode
    *******************************************************************************/
    void Brake_2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Brake_2_0_INTR) != 0u) 
		{ 
			 Brake_2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Brake_2_SUT.c usage_Brake_2_ClearInterrupt
    *******************************************************************************/
